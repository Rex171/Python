...
if err == True:
    ...
    print('Вы ввели неправильный путь или такого не сущетсвует!{}'.format(err))    print('Вы ввели неправильный путь или такого не сущетсвует!')    print('Вы ввели неправильный путь или такого не сущетсвует!')